...
const pool = new Pool({
  connectionString: process.env.DATABASE_URL || 'postgresql://world_happiness_db_user:v6F9ybfgZLheX8urGisZA5iP6V9n7VkN@dpg-d4g39s63jp1c73dcpaug-a.oregon-postgres.render.com/world_happiness_db',
  ssl: {
